        ...
        for (const number of numbers) {
            ...
            try {
                ...
                const errorMessage = apiError.message === 'Service Unavailable' 
                    ? "Service is currently unavailable. Please try again after a few seconds."
                    : "Failed to generate pairing code. Please try again after a few seconds.";
